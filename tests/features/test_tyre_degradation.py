...
def test_tyre_degradation_slope_calculation() -> None:
...
def test_tyre_degradation_slope_min_laps() -> None:
...
def test_tyre_degradation_slope_collinearity() -> None:
...
def test_normalised_tyre_life() -> None:
...
def test_normalised_tyre_life_single_value() -> None:
