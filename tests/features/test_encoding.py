...
import numpy as np
import pytest
from f1_predictions.features.encoding import add_grid_position_features, CategoricalFeatureEncoder

def test_grid_position_features():
    """Verify binary flags and gap for grid positions."""
    data = {
        "GridPosition": [1.0, 2.0, 10.0, 11.0, np.nan]
    }
...
def test_categorical_feature_encoder_basic():
...
def test_categorical_feature_encoder_unknown_category():
...
def test_categorical_feature_encoder_unfitted_raises():
