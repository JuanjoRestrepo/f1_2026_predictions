...
def mock_agent_context():
    with patch("f1_predictions.agents.aero_agent.Agent") as mock_aero, \
...
@pytest.mark.asyncio
async def test_aero_agent(mock_agent_context):
...
@pytest.mark.asyncio
async def test_strategy_agent(mock_agent_context):
...
@pytest.mark.asyncio
async def test_weather_agent(mock_agent_context):
...
@pytest.mark.asyncio
async def test_coordinator_agent(mock_agent_context):
