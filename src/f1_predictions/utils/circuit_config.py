...
class CircuitConfig(BaseModel):
    ...
    streetness: float = Field(
        default=0.30, ge=0.0, le=1.0, description="Street circuit index 0.0-1.0"
    )
    speed_bias: float = Field(
        default=0.50, ge=0.0, le=1.0, description="Speed bias index 0.0-1.0"
    )
    overtaking_ease: float = Field(
        default=0.50, ge=0.0, le=1.0, description="Overtaking ease index 0.0-1.0"
    )
    tyre_stress: float = Field(
        default=0.50, ge=0.0, le=1.0, description="Tyre stress index 0.0-1.0"
    )
