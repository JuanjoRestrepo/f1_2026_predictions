# 🏁 2026 Austrian Grand Prix — Pre-Race AI Intelligence Report (Round 8)

## 1. Podium Projection

Our XGBoost + LightGBM ensemble forecasts the following performance hierarchy:

- **P1 Projected Winner**: **PIA** (McLaren) — `1:10.593`
- **P2**: **BOR** (Audi) — `+0.193s`
- **P3**: **NOR** (McLaren) — `+0.238s`

## 2. Strategic Insights

- **Optimal Strategy**: 1-stop Medium → Hard. Pit window: Lap 28–33.
