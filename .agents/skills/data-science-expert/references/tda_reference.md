...
> **References**: Edelsbrunner, H., & Harer, J. (2010). *Computational Topology: An
> Introduction*. AMS. · Carlsson, G. (2009). Topology and data. *Bulletin of the AMS*,
> 46(2), 255–308. · Cohen-Steiner, D., Edelsbrunner, H., & Harer, J. (2007). Stability
> of persistence diagrams. *Discrete & Computational Geometry*, 37(1), 103–120. ·
> Takens, F. (1981). Detecting strange attractors in turbulence. *Lecture Notes in
> Mathematics*, 898, 366–381. · Tauzin, G., et al. (2021). giotto-tda: A topological
> data analysis toolkit for machine learning and data exploration. *JMLR*, 22(39).
...
**k-cycles**: Z_k = ker(∂_k) — chains with no boundary (closed loops)
**k-boundaries**: B_k = im(∂_{k+1}) — chains that are boundaries of higher simplices
Since ∂² = 0: B_k ⊆ Z_k

**k-th homology group**: H_k = Z_k / B_k = ker(∂_k) / im(∂_{k+1})
...
```
**Takens' theorem**: for generic (f, τ), Φ_{f,τ} is a smooth embedding
...
time series: Landscapes of crashes. *Physica A*, 491, 820–834. (Methodology
...
- Hu, X., et al. (2019). Topology-preserving deep image segmentation. *NeurIPS*.

**Higher-order TDA:**
- Barbarossa, S., & Sardellitti, S. (2020). Topological signal processing over simplicial complexes. *IEEE TSP*, 68, 2992–3007.
- Hansen, J., & Ghrist, R. (2021). Toward a spectral theory of cellular sheaves. *Journal of Applied and Computational Topology*, 3(4), 315–358.

**Software:**
- Tauzin, G., et al. (2021). giotto-tda: A topological data analysis toolkit for machine learning. *JMLR*, 22(39). https://giotto-ai.github.io/gtda-docs/
- Bauer, U. (2021). Ripser: Efficient computation of Vietoris-Rips persistence barcodes. *Journal of Applied and Computational Topology*, 5(3), 391–423. https://github.com/Ripser/ripser
